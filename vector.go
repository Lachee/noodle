...
func NewVector2(x, y float64) Vector2 { return Vector2{X: x, Y: y} }

//NewVector2d creates a new vector with double precesion float (float64)
func NewVector2d(x, y, z float64) Vector2 { return Vector2{X: x, Y: y} }
...
func (v Vector2) Decompose() []float64 { return []float64{v.X, v.Y} }
...
func (v Vector2) RotateByRadians(radians float64) Vector2 {
...
func (v Vector2) Angle(v2 Vector2) float64 {
	result := math.Atan2(v2.Y-v.Y, v2.X-v.X) * Rad2Deg
	if result < 0 {
		result += 360
	}
	return result
...
func (v Vector2) Divide(d float64) Vector2 {
...
func (v Vector2) Min(v2 Vector2) Vector2 {
	return Vector2{
		X: math.Min(float64(v.X), float64(v2.X)),
		Y: math.Min(float64(v.Y), float64(v2.Y)),
	}
}
...
func (v Vector2) Max(v2 Vector2) Vector2 {
	return Vector2{
		X: math.Max(float64(v.X), float64(v2.X)),
		Y: math.Max(float64(v.Y), float64(v2.Y)),
	}
}
...
//Decompose the vector into a slice of floats
func (v Vector3) Decompose() []float64 { return []float64{v.X, v.Y, v.Z} }
...
//SqrLength is the squared length of the vector
func (v Vector3) SqrLength() float64 {
...
func (v Vector3) Angle(v2 Vector3) float64 {
	result := math.Acos(Clamp(v.DotProduct(v2), -1, 1)) * Rad2Deg
	if result < 0 {
		result += 360
	}
	return result
...
func NewVector4(x, y, z, w float64) Vector4 { return Vector4{X: x, Y: y, Z: z, W: w} }

//NewVector4Zero creates a vector with all components equaling 0
func NewVector4Zero() Vector4 { return Vector4{X: 0, Y: 0, Z: 0, W: 0} }

//Decompose the vector into a slice of floats
func (v Vector4) Decompose() []float64 { return []float64{v.X, v.Y, v.Z, v.W} }
...
//Divide  a vector by a value (v / d)
func (v Vector4) Divide(d float64) Vector4 {
...
//SqrLength is the squared length of the vector
func (v Vector4) SqrLength() float64 {
	return (v.X * v.X) + (v.Y * v.Y) + (v.Z * v.Z) + (v.W * v.W)
}

//DotProduct of the vector
func (v Vector4) DotProduct(v2 Vector4) float64 {
...
//Distance between two vectors
func (v Vector4) Distance(v2 Vector4) float64 {
	d := v2.Subtract(v)
	return d.Length()
}
